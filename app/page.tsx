    ...
    <>
      <div className="container flex justify-center flex-col-reverse xl:flex-row h-screen">
        <div className=" xl:w-1/2">
          ...
          <p className="text-2xl pt-20">Get started by editing app directory
          <br/>
            <code className="text-blue-500">pages/index.js</code><br/>
            add your types to lib/types
          </p>
          <div className="pt-20">
            <Link href="/metaverse" className="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">Start Creating</Link>
          </div>
        </div>
