    ...
    <>
      <div className="container flex justify-center flex-col-reverse xl:flex-row h-screen">
        <div className=" xl:w-1/2">
          <h1 className="xl:text-4xl  text-8xl xl:pt-20">
            Welcome to Nextjs with Tailwind css and mongodb
          </h1>
        ...
        <div className="xl:w-1/2 w-full h-1/2">
          <Image
            src={
              "https://cdn.dribbble.com/userupload/3253954/file/original-eca5bf9580fded837c78ab35c4464fb1.jpg?compress=1&resize=1024x709"
            }
            width={800}
            height={500}
            alt="Image"
